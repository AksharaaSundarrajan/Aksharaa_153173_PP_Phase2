...
private Map<String, Customer> data= new HashMap<>();
	...
	if(amountIsValid(amount)) {
		if(balance1.getBalance().compareTo(amount)>=0)
		{
			...
			repo.updateBalance(sourceMobileNo, deductedBalance);
			repo.updateBalance(targetMobileNo, addedbalance);
	...
	public Customer depositAmount(String mobileNo, BigDecimal amount) 
	{
		...
		if(amountIsValid(amount))
		{
			...
			repo.updateBalance(mobileNo, balanceAfterDeposit);
	...
	public Customer withdrawAmount(String mobileNo, BigDecimal amount) 
	{
		...
		if(amountIsValid(amount))
		{
			...
			repo.updateBalance(mobileNo, balanceAfterWithdrawal);
			try {
